 ...
 *******************************************************************************/
package org.openhealthtools.mdht.cda.gradle.example;
...
//			encounter.getTemplateIds().add(DatatypesFactory.eINSTANCE.createII("2.16.840.1.113883.10.20.22.4.49",
// "2015-08-01"));
//			encounter.getTemplateIds().add(DatatypesFactory.eINSTANCE.createII("2.16.840.1.113883.10.20.24.3.23",
// "2016-02-01"));
//			encounter.getIds().add(DatatypesFactory.eINSTANCE.createII("2.16.840.1.113883.3.3619.99.7",
// "Inpatient999"));
//			 
...
//			encounter.setEffectiveTime(EffectiveTimeSegment.createIVLTSEffectiveTime("20150101000000+0530",
// "20151231000000+0530"));

            encounter.getSDTCDischargeDispositionCodes().add(DatatypesFactory.eINSTANCE.createCE("10161009",
...
//			if(null != encounterModel.getPrincipalDiagnosisList()){
            ...
            observation.setCode(DatatypesFactory.eINSTANCE.createCD("8319008", "2.16.840.1.113883.6.96", "SNOMED-CT",
					"Principal Diagnosis"));
            observation.getValues().add(DatatypesFactory.eINSTANCE.createCD("707980005", "2.16.840.1.113883.6.96",
					"SNOMED-CT", null));
